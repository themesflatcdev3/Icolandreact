    ...
    return (
        <section className='dashboard'>
            ...
            <nav className={`dashboard__sidebar ${toggleClassclick}`}>
                ...
                <li><Link to="/dashboard-roadmap" className="active"><span className="icon-map"></span>Road Map</Link></li>
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-6 col-md-12">
                                    <div className="group-img">
                                        <img src={require ('../../../assets/images/item/nft-rm-01.png')} alt="ICOLand" />
                                        <img src={require ('../../../assets/images/item/nft-rm-02.png')} alt="ICOLand" />
                                        <img src={require ('../../../assets/images/item/nft-rm-03.png')} alt="ICOLand" />
                                    </div>
                                </div>
